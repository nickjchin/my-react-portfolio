      ...
      <div className="card">
        ...
        <div className="card-body">
          ...
          <p className="card-text">
            Created using with Node, Express, Sequelize, MySQL, and Handlebars. Stock Shout allows
            the user to create an account, login, save a list of apps to their watchlist, and view
            tweets and stock information
          </p>
          <a
    ...
    <div className="col-md-4 col-sm-6 mb-4">
      <div className="card">
        ...
        <div className="card-body">
          <p className="card-text">Description:</p>
          <p className="card-text">
            Created using server-side API from OpenWeather API to display the current weather and 5
            day forecasts for selected cities
          </p>
          <a
    ...
    <div className="col-md-4 col-sm-6 mb-4">
      <div className="card">
        ...
        <div className="card-body">
          <p className="card-text">Description:</p>
          <p className="card-text">
            Created using HTML, CSS, Bootstrap, Node and Express. Note Taker is hosted on Heroku and
            the app allows the user to create and notes.
          </p>
          <a
